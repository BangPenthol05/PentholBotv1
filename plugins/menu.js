...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command}) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'edukasi', 'news', 'random', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'nulis', 'downloader', 'tools', 'fun', 'database','quran', 'vote',, 'audio', 'jadibot', 'info', 'owner', 'nocategory']
...
const listMessage = {
 ...
 let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
  ...
  "businessOwnerJid": `${m.sender.split`@`[0]}@s.whatsapp.net`
    ...
    let urls = pickRandom(['https://telegra.ph/file/b4f8011692d962f4bcb0e.png', 'https://telegra.ph/file/db29da093c2fc11973e58.png', 'https://telegra.ph/file/74e4e31606722292b6364.png', 'https://telegra.ph/file/16b6d02192a69e336e4ae.png', 'https://telegra.ph/file/052d894daf9826d35e513.png', 'https://telegra.ph/file/43024e46f91a75fa64be8.png', 'https://telegra.ph/file/f161a74c270d454c0e999.png', 'https://telegra.ph/file/3c102fe508a86936fa570.png'])
...
//-------DOC TEMPLATE
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://github.com/BangPenthol05/Elaina-MultiDevice'
                    }
                },
                {
                    urlButton: {
    ...
    //------------------- 2BUTTON VID
   // conn.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/c82d5c358495e8ef15916.mp4' }, gifPlayback: true, gifAttribution: ~~(Math.random() * 2), caption: text.trim(), footer: 'ᴍᴀᴅᴇ ᴡɪᴛʜ ❤ BangPenthol', templateButtons: [{ quickReplyButton: { displayText: 'Speedtest⚡', id: `${_p}speedtest` }}, { quickReplyButton: { displayText: 'Owner🎀', id: `${_p}owner` }} ] })
...
function timeimg() {
    let imgloc = ''
  const time = moment.tz('Asia/Jakarta').format('HH')
  imgloc = ('./media/pentholbot8.png')
  if (time >= 0) {
    imgloc = ('./media/pentholbot7.png')
  }
  if (time >= 4) {
    imgloc = ('./media/pentholbot1.png')
  }
  if (time >= 8) {
    imgloc = ('./media/pentholbot2.png')
  }
  if (time >= 12) {
    imgloc = ('./media/pentholbot3.png')
  }
  if (time >= 16) {
    imgloc = ('./media/pentholbot4.png')
  }
  if (time >= 20) {
    imgloc = ('./media/pentholbot5.png')
  }
  if (time >= 24) {
    imgloc = ('./media/pentholbot6.png')
  }
  return imgloc
}
